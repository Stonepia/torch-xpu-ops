...
UPSTREAM_ISSUE_REPO = os.environ.get("UPSTREAM_ISSUE_REPO", _repos.get("xpu_ops_upstream", "intel-sandbox/agentic_xpu"))
ISSUE_REPO = os.environ.get("ISSUE_REPO", _repos.get("xpu_ops_issue", "intel-sandbox/agentic_xpu"))
...
TRACKING_REPO = os.environ.get("TRACKING_REPO", _repos.get("tracking", "intel-sandbox/agentic_xpu"))
